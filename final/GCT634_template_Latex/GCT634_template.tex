% -----------------------------------------------
% Template for KAIST GCT634/AI613 Final report
...
% Title.
% ------
\title{Paper Template For KAIST GCT634/AI613}
...
% --------------
\threeauthors
  {First Author} {Affiliation1 \\ {\tt author1@kaist.ac.kr}}
  {Second Author} {Affiliation2 \\ {\tt author2@kaist.ac.kr}}
  {Third Author} {Affiliation3 \\ {\tt author3@kaist.ac.kr}}
...
This template includes all the information about formatting manuscripts for KAIST GCT634/AI613.
...
The paper length is expected to have 3 to 4 pages including references. 
...
``A'' did the writing of the introduction and related work sections. ``B'' collected datasets and conducted experiments for the baseline algorithm. ``C'' proposed a new idea and implemented it.

% For bibtex users:
\bibliography{GCT634_template}
